...
export default function Aside() {
    return (
        <main className="h-[37rem] bg-white dark:bg-slate-700 w-80 rounded-3xl lg:flex flex-col justify-center items-center px-5 hidden">
            {/* Image */}
            <div className="pimage w-40 h-40 bg-[#FF9C1A] -mt-32 rounded-2xl" style={{ backgroundImage: 'url(/profile.jpg)', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>

            </div>

            {/* Text */}
            <h1 className={`text-3xl font-bold mt-3`}>Chidimma .B Umeayo</h1>
